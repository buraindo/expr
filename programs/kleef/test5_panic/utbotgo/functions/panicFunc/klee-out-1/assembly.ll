...
then.1:                                           ; preds = %else.0
  ...
  %3 = call i8* @memcpy(i8* %cast.3, i8* bitcast ({ %_type.0*, i8* }* @const.2 to i8*), i64 16)
  %cast.4 = bitcast { %_type.0*, i8* }* %tmpv.0 to { i8*, i8* }*, !dbg !61
  %field0.0 = getelementptr inbounds { i8*, i8* }, { i8*, i8* }* %cast.4, i32 0, i32 0, !dbg !61
  %ld.0 = load i8*, i8** %field0.0, align 8, !dbg !61
  %field1.0 = getelementptr inbounds { i8*, i8* }, { i8*, i8* }* %cast.4, i32 0, i32 1, !dbg !61
...
then.3:                                           ; preds = %entry
  ...
  %cast.7 = bitcast %.runtime.gQueue.0* %"$p23.addr" to { i64, i64 }*, !dbg !468
  %field0.1 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %cast.7, i32 0, i32 0, !dbg !468
  %ld.2 = load i64, i64* %field0.1, align 8, !dbg !468
  %field1.1 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %cast.7, i32 0, i32 1, !dbg !468
...
entry:
  ...
  %cast.11 = bitcast i8* %key1.ld.0 to { %.runtime.gList.0, i32 }*, !dbg !484
  store { %.runtime.gList.0, i32 }* %cast.11, { %.runtime.gList.0, i32 }** %tmpv.7, align 8
  %key2.ld.0 = load i8*, i8** %key2.addr, align 8, !dbg !484
  %cast.12 = bitcast i8* %key2.ld.0 to { %.runtime.gList.0, i32 }*, !dbg !484
...
then.7:                                           ; preds = %then.6
  ...
  %cast.14 = bitcast %.runtime.gList.0* %tmpv.9 to i8*, !dbg !484
  %cast.15 = bitcast %.runtime.gList.0* %field.4 to i8*, !dbg !484
  %0 = call i8* @memcpy(i8* %cast.14, i8* %cast.15, i64 8), !dbg !484
  %cast.16 = bitcast %.runtime.gList.0* %tmpv.13 to i8*
  %cast.17 = bitcast %.runtime.gList.0* %tmpv.9 to i8*
  %1 = call i8* @memcpy(i8* %cast.16, i8* %cast.17, i64 8)
...
then.8:                                           ; preds = %else.7
  ...
  %cast.19 = bitcast %.runtime.gList.0* %tmpv.10 to i8*, !dbg !484
  %cast.20 = bitcast %.runtime.gList.0* %field.5 to i8*, !dbg !484
  %2 = call i8* @memcpy(i8* %cast.19, i8* %cast.20, i64 8), !dbg !484
  %cast.21 = bitcast %.runtime.gList.0* %tmpv.15 to i8*
  %cast.22 = bitcast %.runtime.gList.0* %tmpv.10 to i8*
  %3 = call i8* @memcpy(i8* %cast.21, i8* %cast.22, i64 8)
...
entry:
  ...
  %cast.25 = bitcast i8* %key1.ld.3 to [61 x { i32, i64, i64 }]*, !dbg !499
  store [61 x { i32, i64, i64 }]* %cast.25, [61 x { i32, i64, i64 }]** %tmpv.20, align 8
  %key2.ld.3 = load i8*, i8** %key2.addr, align 8, !dbg !499
  %cast.26 = bitcast i8* %key2.ld.3 to [61 x { i32, i64, i64 }]*, !dbg !499
...
then.15:                                          ; preds = %fallthrough.14
  ...
  %cast.28 = bitcast { i32, i64, i64 }* %tmpv.25 to i8*, !dbg !499
  %cast.29 = bitcast { i32, i64, i64 }* %index.0 to i8*, !dbg !499
  %0 = call i8* @memcpy(i8* %cast.28, i8* %cast.29, i64 24), !dbg !499
  %cast.30 = bitcast { i32, i64, i64 }* %tmpv.29 to i8*
  %cast.31 = bitcast { i32, i64, i64 }* %tmpv.25 to i8*
  %1 = call i8* @memcpy(i8* %cast.30, i8* %cast.31, i64 24)
...
then.17:                                          ; preds = %fallthrough.16
  ...
  %cast.33 = bitcast { i32, i64, i64 }* %tmpv.26 to i8*, !dbg !499
  %cast.34 = bitcast { i32, i64, i64 }* %index.1 to i8*, !dbg !499
  %2 = call i8* @memcpy(i8* %cast.33, i8* %cast.34, i64 24), !dbg !499
  %cast.35 = bitcast { i32, i64, i64 }* %tmpv.31 to i8*
  %cast.36 = bitcast { i32, i64, i64 }* %tmpv.26 to i8*
  %3 = call i8* @memcpy(i8* %cast.35, i8* %cast.36, i64 24)
...
entry:
  ...
  %cast.37 = bitcast i8* %key1.ld.4 to { i32, i64, i64 }*, !dbg !504
  store { i32, i64, i64 }* %cast.37, { i32, i64, i64 }** %tmpv.34, align 8
  %key2.ld.4 = load i8*, i8** %key2.addr, align 8, !dbg !504
  %cast.38 = bitcast i8* %key2.ld.4 to { i32, i64, i64 }*, !dbg !504
...
entry:
  ...
  %cast.45 = bitcast i8* %key1.ld.10 to [33 x double]*, !dbg !534
  store [33 x double]* %cast.45, [33 x double]** %tmpv.47, align 8
  %key2.ld.10 = load i8*, i8** %key2.addr, align 8, !dbg !534
  %cast.46 = bitcast i8* %key2.ld.10 to [33 x double]*, !dbg !534
...
entry:
  ...
  %cast.49 = bitcast i8* %key1.ld.18 to [27 x { i8*, i64 }]*, !dbg !574
  store [27 x { i8*, i64 }]* %cast.49, [27 x { i8*, i64 }]** %tmpv.61, align 8
  %key2.ld.18 = load i8*, i8** %key2.addr, align 8, !dbg !574
  %cast.50 = bitcast i8* %key2.ld.18 to [27 x { i8*, i64 }]*, !dbg !574
...
then.39:                                          ; preds = %fallthrough.38
  ...
  %0 = call i8* @memcpy(i8* %cast.52, i8* %cast.53, i64 16)
...
then.40:                                          ; preds = %else.39
  ...
  %1 = call i8* @memcpy(i8* %cast.55, i8* %cast.56, i64 16)
